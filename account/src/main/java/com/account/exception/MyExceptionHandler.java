...
public class MyExceptionHandler {
    ...
    public ResponseBean exceptionHandler(MyException e){
        ...
        return ResponseBean.msgWithCode(e.getErrorCode(),e.getErrorMessage());
    }
    ...
    public ResponseBean exceptionHandler(NullPointerException e){
        ...
        return ResponseBean.msgWithCode(ResponseBean.Code.serverError,e.getMessage());
    }
    ...
    public ResponseBean exceptionHandler(UnauthorizedException e) {
        ...
        return ResponseBean.msgWithCode(ResponseBean.Code.serverError,"无权限访问");
    }

    @ExceptionHandler(value = UnauthenticatedException.class)
    public ResponseBean exceptionHandler(UnauthenticatedException e) {
        log.error("登录验证异常！原因是:" + e);
        return ResponseBean.msgWithCode(ResponseBean.Code.authenticationRequired,"身份验证失败");
    }

    @ExceptionHandler(value = DuplicateKeyException.class)
    public ResponseBean exceptionHandler(DuplicateKeyException e) {
        log.error("数据重复！原因是:"+e);
        return ResponseBean.msgWithCode(ResponseBean.Code.serverError,"数据已存在");
    }
